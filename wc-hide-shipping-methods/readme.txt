...
**Automatic Shipping Method Hiding 🚫**
This feature hides all other shipping options when “Free Shipping” is available, resulting in a cleaner checkout experience.

**Local Pickup Option 📍**
This feature lets you keep the “Local Pickup” and “Free Shipping” options. Customers can benefit from these options by quickly receiving their orders using the first option.
Moreover, customers who prefer to receive their orders without paying the delivery charges can consider using the “Free Shipping” option.

**Additional Shipping Methods 🚚**
Administrators can select extra shipping methods (pulled from available WooCommerce shipping zones) to display in addition to the default options.

**Seamless WooCommerce Integration 🔗**
Smartly manage your online store using the multiple controls and options WooCommerce offers. Improve the performance of your store to new heights.

**Shipping Zone Compatibility 🌐**
It helps dynamically pull shipping methods from your WooCommerce shipping zones.
...
== Screenshots ==
1. Wholesale For WooCommerce General Tab
